...
public class DreamerController extends BaseController {
    ...
    private void setSessionInfoInSession(Dreamer d, HttpSession session, HttpServletRequest req) {
    ...
    public RespStruct loginWithPhone(
        ...
        d.setPhone(phone);
        d = dreamerDao.select(d);
        if (d == null) return failed(ConstString.NOT_VALID_USERNAME, ConstString.NOT_VALID_USERNAME_CODE);
